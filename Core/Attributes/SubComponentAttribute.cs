...
public sealed class SubComponentAttribute<T>() : SubComponentAttributeInternal where T : struct, Enum
{
    /// <summary>
...
public abstract class SubComponentAttributeInternal : Attribute
{
