...
public class UserController : ControllerBase
{
    ...
    public async Task<IActionResult> UploadImage([FromForm] Component Type = Core.Models.Components.Component.None, [FromForm] string email = UserConsts.DemoUser, [FromForm] string token = UserConsts.DemoToken, [FromForm] IFormFile? image = null, [FromForm] string? name = null)
    {
