...
namespace Web.Views.Shared.Components.BloodPressure;

public class BloodPressureViewModel
{
    public BloodPressureViewModel(Data.Entities.User.User user, IList<UserBloodPressure>? userMoods)
    {
        if (userMoods != null)
        {
            var daysBack = Enumerable.Range(0, user.GetComponentDaysFor(Component.BloodPressure));
