...
namespace Web.Views.Shared.Components.SalivaStress;

public class SalivaStressViewModel
{
    public SalivaStressViewModel(IList<UserSalivaStress>? userMoods, List<UserCustom>? customs)
    {
    ...
    public UserSalivaStress UserMood { get; init; } = null!;
    public UserSalivaStress? PreviousMood { get; init; }
