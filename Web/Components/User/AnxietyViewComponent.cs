...
/// </summary>
public class AnxietyViewComponent(IServiceScopeFactory serviceScopeFactory, CoreContext context, UserRepo userRepo) : ViewComponent
{
    /// <summary>
    /// For routing
    /// </summary>
    ...
    public async Task<IViewComponentResult> InvokeAsync(Data.Entities.User.User user)
    {
        ...
        var viewModel = new AnxietyViewModel(userMoods, null)
        {
