...
using Web.Views.Shared.Components.GeneralizedAnxietySeverity;
...
/// </summary>
public class GeneralizedAnxietySeverityViewComponent(CoreContext context, UserRepo userRepo) : ViewComponent
{
    /// <summary>
    /// For routing.
    /// </summary>
    ...
    public async Task<IViewComponentResult> InvokeAsync(Data.Entities.Users.User user)
    {
        ...
        return View("GeneralizedAnxietySeverity", new GeneralizedAnxietySeverityViewModel(userMoods)
        {
            User = user,
            Token = token,
            PreviousMood = userMood,
            UserMood = new Data.Entities.Users.UserGeneralizedAnxietySeverity()
            {
                UserId = user.Id,
                User = user
            },
