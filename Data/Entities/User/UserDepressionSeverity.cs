...
public class UserDepressionSeverity
{
    ...
    [Range(0, 3)]
    [Display(Name = "Feeling down, depressed, or hopeles")]
    ...
    [Range(0, 3)]
    [Display(Name = "Feeling bad about yourself—or that you are a failure or \r\nhave let yourself or your family down")]
    public int? FeelingBad { get; set; }

    [Range(0, 3)]
    [Display(Name = "Trouble concentrating on things, such as reading the \r\nnewspaper or watching televisio")]
    public int? NoConcentration { get; set; }

    [Range(0, 3)]
    [Display(Name = "Moving or speaking so slowly that other people could have \r\nnoticed? Or the opposite—being so fidgety or restless \r\nthat you have been moving around a lot more than usual\r\n")]
    public int? Slowly { get; set; }

    [Range(0, 3)]
    [Display(Name = "Thoughts that you would be better off dead or of hurting \r\nyourself in some way ")]
