...
public class CoreContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        ////////// Partial Indexes ////////// Only filter out disabled reason if there's a global query filter set for it.
        //modelBuilder.Entity<UserTask>().Metadata.GetIndexes().ToList().ForEach(index => index.SetFilter(DISABLED_REASON_IS_NULL));
